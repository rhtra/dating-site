...
import {MultiStepFormContext} from '../../../MultiStepForm.jsx'
    ...
    return (
        ...
        >
            ...
            <ul className="multi-step-form-step-two-plans">
                {plans.map(({id, planName, monthlyPrice, yearlyPrice, img, free, desc})=>(
                    ...
                    >
                        ...
                        {!isMonthly && free > 0 ? <p>{free} Months free</p> : null}
                        <p className="multi-step-form-step-desc">{desc}</p>
                    </li>
                ))}
            </ul>
